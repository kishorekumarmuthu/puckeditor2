...
import { ExportIconConfig, Hero, HeroProps, ToggleSwitch } from "./blocks/Hero";
...
import ToggleSwitch from "./blocks/Hero/ToggleSwitch";
import { useMyContext } from "./blocks/Hero/ToggleSwitch";
import { ToggleSwitchComponent } from "./blocks/Hero/ToggleSwitchComponent";
import { Example } from "./blocks/Hero/ExampleComp";
...
export type Props = {
  ...
  ToggleSwithComponent: ToggleSwitch;
...
export const conf: UserConfig = {
  ...
  categories: {
    ...
    interactive: {
      title: "Actions",
      components: ["ButtonGroup", "ToggleSwitchComponent"],
    },
  },
  components: {
    ButtonGroup,
...
let initialDataDup: Record<string, UserData> = {};

const InitialDataFunction = () => {
  //const { isChecked } = useMyFirstCustomHook();

  initialDataDup = {
    "/": {
      //this is the initial data to render on the body
      content: [
        {
          type: "Hero",
          props: {
  ...
  return initialDataDup;
};

//const MyFunctionWrapper = () => {
export const initialData: Record<string, UserData> = InitialDataFunction(); // Now the hook is used correctly inside a component
console.log(initialData);
//return initialData;
//};

//export const initialData: Record<string, UserData> = MyFunctionWrapper();
